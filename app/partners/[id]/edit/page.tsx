...
export default function EditPartner() {
  ...
  // Mock data (real θα τραβάει από Supabase με id)
  const mockPartner = {
    id: id as string,
    name: 'Blue Villas',
    ...
    phone: '22890 12345',
    website: 'https://bluevillas.gr',
    username: 'nikospapad', // ΝΕΟ: προ-γεμισμένο
    password: '12345678', // ΝΕΟ: προ-γεμισμένο (real θα είναι hashed)
    isB2B: true,
  ...
  const [website, setWebsite] = useState(mockPartner.website)
  const [username, setUsername] = useState(mockPartner.username)
  const [password, setPassword] = useState(mockPartner.password)
  ...
  const handleSave = () => {
    ...
    console.log('Partner updated (ID:', id, '):', {
      name,
      contactPerson,
      email,
      phone,
    ...
    alert(`Συνεργάτης #${id} ενημερώθηκε επιτυχώς!`)
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="bg-white border-b border-slate-200 px-8 py-6">
        ...
        <p className="text-slate-600 mt-1">Ενημέρωση στοιχείων</p>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                placeholder="https://www.bluevillas.gr"
            ...
            <div>
              ...
              <input
                ...
                placeholder="nikos@bluevillas.gr"
                className="w-full px-4 py-4 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="22890 12345"
                className="w-full px-4 py-4 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
              />
            </div>
          </div>

          {/* Στοιχεία Εισόδου στο B2B Portal */}
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <span className="text-lg font-medium text-slate-700">B2B Συνεργάτης</span>
            </div>
            {isB2B && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={b2bCommissionType === 'percentage' ? '12' : '50'}
                    className="w-full px-4 py-4 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                  />
                </div>
              </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <input
                ...
                className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500"
              />
              <span className="text-lg font-medium text-slate-700">Εξωτερικός Συνεργάτης</span>
            </div>
            {isExternal && (
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <input
                ...
                className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500"
              />
              <span className="text-lg font-medium text-slate-700">Referral</span>
            </div>
            {referralEnabled && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={referralType === 'percentage' ? '5' : '30'}
                    className="w-full px-4 py-4 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                  />
                </div>
              </div>
