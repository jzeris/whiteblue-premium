...
export default function EditUser() {
  ...
  const [name, setName] = useState('Γιάννης Διαχειριστής')
  const [email, setEmail] = useState('giannis@whiteblue.gr')
  const [phone, setPhone] = useState('+30 690 0000001')
  const [username, setUsername] = useState('giannis_admin')
  const [password] = useState('********') // read-only
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200 px-8 py-6">
        <h1 className="text-3xl font-bold text-slate-900">Επεξεργασία Χρήστη</h1>
        <p className="text-slate-600 mt-1">Ενημέρωση στοιχείων και δικαιωμάτων</p>
      </div>
